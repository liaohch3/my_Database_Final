<template>
	<view>
		<view class="header">
			<view class="bg" :style="{'background-color': current_skin}">
<!-- 			<view :class="{ 'background-color': current_skin, width: 100%, height:200upx, padding-top:100upx}"> -->
				<view class="box">
					<view class="box-hd">
						<view class="avator" @click="ClickToInfo">
							<img :src="avatarUrl">
						</view>
						<view class="phone-number">{{nickName}}</view>
					</view>
					<view class="box-bd">
						<view class="item">
		...
		<view class="list-content">
			<view class="list">
				<view class="li noborder" @click="ClickToInfo" >
	...
	export default {
		data() {
			return {
				...
				openid: '',
				session_key: '',
				avatarUrl: 'https://ws1.sinaimg.cn/large/007RvR0Hly1gack42dh16j307g0b4q6o.jpg',
				current_skin: '#4191ea',
			};
		},
		onShow() {
			this.current_skin = uni.getStorageSync('current_skin');
